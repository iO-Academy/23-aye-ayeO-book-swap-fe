...
function BookDetails({ image, title, author, year, pageCount, genre, blurb, reviews, claimed, getBookData, refreshReviewsList }) {
    ...
    return (
        <div className="w-full max-w-7xl m-auto bg-zinc-100">
            <div className="book-details w-full m-auto p-20 pt-16 sm:pt-32 flex flex-col md:flex-row justify-center min-[1280px]:gap-24 gap-10">
                ...
                <div className="flex flex-col gap-2 w-[1200px]">
                    ...
                    {claimed ? (
                        <button data-element="return" onClick={toggleReturn} className="button py-2 w-max">
                            Return Book
                        </button>
                    ) : (
                        <button data-element="claim" onClick={toggleClaim} className="button py-2 w-max">
                            Claim Book
                        </button>
                    )}
