...
function Bookshelf({ claimed }) {
    ...
    function showFilter() {
        isFilterVisible === "-translate-y-full" ? setIsFilterVisible("translate-y-0") : setIsFilterVisible("-translate-y-full");
    }
    ...
    return (
        <>
            ...
            <div
                className={`bg-zinc-200 sm:pt-[68px] sm:flex transition absolute sm:relative transform z-10 w-full rounded-b-lg ${isFilterVisible} sm:translate-y-0`}
                id="filter"
            >
