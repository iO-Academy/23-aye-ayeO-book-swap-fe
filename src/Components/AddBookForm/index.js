...
function AddBookForm() {
  ...
  function handleSuccess(g, ol) {
    ...
    // COVER
    g1.items &&
      (coverG = removeEdgeCurl(g1.items[0]?.volumeInfo?.imageLinks?.thumbnail));
    ...
    <>
      ...
      <div className="sm:pt-24">
        ...
        <div className="m-auto mb-5 max-w-[750px] bg-[#34345020] px-6 pb-8 pt-2 text-slate-600 ring-inset ring-orange-100 transition sm:rounded-lg  sm:p-16 sm:ring-8">
          <div id="scanner" className="overflow-hidden rounded-xl"></div>
          <br />
          ...
          <div
            className={`overflow-hidden rounded-md bg-slate-300 pb-2
                        ${
                          ...
                          !remoteSuccess &&
                          !isbnError &&
                          "background-animate rounded-t border-none bg-gradient-to-r from-slate-300 via-rose-200 to-slate-300"
                        }
          ...
          >
            ...
            <div className="flex flex-row items-center gap-3 py-2 pb-0 text-slate-600">
              ...
              {isbnError && !title && (
                <div className="px-4"> {displayErrorMessage(isbnError)}</div>
              )}
        ...
        <div className="form-container relative !my-0 !px-6 sm:my-5 sm:px-0 sm:pt-5 md:max-w-[750px]">
          ...
          >
            ...
            <div>
              ...
              {genreError &&
                displayErrorMessage("Category selection is required")}
            </div>
            <div className="flex flex-col justify-between gap-3 sm:flex-row">
              ...
              <div className="sm:w-1/2">
                <label htmlFor="isbn13">
                  ISBN-13 <span className="text-rose-600">*</span>
                </label>
                ...
                <input
                  ...
                  className={
                    isbn13Error ? "input-error form-text" : "form-text"
                  }
                />
                {isbn13Error && displayErrorMessage("ISBN-13 is required")}
              </div>
              <div className="sm:w-1/2">
                <label htmlFor="isbn10">
                  ISBN-10 <span className="text-rose-600">*</span>
                </label>
                ...
                <input
                  ...
                  className={
                    isbn10Error ? "input-error form-text" : "form-text"
                  }
                />
                {isbn10Error && displayErrorMessage("ISBN-10 is required")}
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={
                  pageCountError ? "input-error form-text" : "form-text"
                }
              />
            ...
            <div>
              ...
              <input
                ...
                className={
                  imageUrlError ? "input-error form-text" : "form-text"
                }
              />
              {imageUrlError &&
                displayErrorMessage("Valid cover URL is required")}
            </div>
