    ...
    return (
        <div className='form-container'>
            <form onSubmit={validateForm} className='flex flex-col gap-4 w-3/4'>
                <h1 className='text-3xl py-10 text-slate-600 text-center'>
                    Add New Book
                </h1>
                ...
                <input
                    type='submit'
                    value='Add book'
                    className='rounded-md py-3 px-4 bg-rose-400 border  hover:bg-transparent hover:border hover:border-rose-500 hover:text-rose-500 text-slate-50 text-base transition'
                />
            </form>
        </div>
    );
